...
const documents: Documents = {
  ...
  "\n  query QuoteEventsForQuotesByType(\n    $quoteIds: [BigInt!]!\n    $typeIn: [String!]!\n    $first: Int!\n    $skip: Int!\n    $orderDirection: OrderDirection!\n  ) {\n    quoteEvents(\n      first: $first\n      skip: $skip\n      orderBy: timestamp\n      orderDirection: $orderDirection\n      where: { quoteId_in: $quoteIds, type_in: $typeIn }\n    ) {\n      id\n      type\n      metadata\n      timestamp\n      blockNumber\n      transaction\n      quoteId\n    }\n  }\n":
    types.QuoteEventsForQuotesByTypeDocument,
};
...
export function graphql(
  source: "\n  query PoolQuotes(\n    $symbolId: BigInt!\n    $source: Bytes!\n    $quoteStatuses: [Int!]!\n    $first: Int!\n    $skip: Int!\n    $orderDirection: OrderDirection!\n  ) {\n    quotes(\n      first: $first\n      skip: $skip\n      orderBy: timestamp\n      orderDirection: $orderDirection\n      where: { symbolId: $symbolId, source: $source, quoteStatus_in: $quoteStatuses }\n    ) {\n      id\n      quoteId\n      quoteStatus\n      positionType\n      orderTypeOpen\n      symbol\n      symbolId\n      partyA\n      partyB\n      quantity\n      closedAmount\n      quantityToClose\n      openedPrice\n      requestedOpenPrice\n      averageClosedPrice\n      closePrice\n      initialOpenedPrice\n      liquidateAmount\n      liquidatePrice\n      timestamp\n      blockNumber\n    }\n  }\n",
): typeof import("./graphql").PoolQuotesDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "\n  query PoolQuoteEvents(\n    $typeIn: [String!]!\n    $symbolId: BigInt!\n    $source: Bytes!\n    $first: Int!\n    $skip: Int!\n    $orderDirection: OrderDirection!\n  ) {\n    quoteEvents(\n      first: $first\n      skip: $skip\n      orderBy: timestamp\n      orderDirection: $orderDirection\n      where: { type_in: $typeIn, quote_: { symbolId: $symbolId, source: $source } }\n    ) {\n      id\n      type\n      metadata\n      timestamp\n      quoteId\n      blockNumber\n      transaction\n      quote {\n        quoteId\n        quoteStatus\n        positionType\n        orderTypeOpen\n        symbol\n        symbolId\n        partyA\n        partyB\n        subAccount {\n          id\n        }\n        quantity\n        openedPrice\n        requestedOpenPrice\n        averageClosedPrice\n        closePrice\n        closedAmount\n        quantityToClose\n        liquidateAmount\n        liquidatePrice\n      }\n    }\n  }\n",
): typeof import("./graphql").PoolQuoteEventsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
...
export function graphql(
  source: "\n  query QuoteEventsForQuotesByType(\n    $quoteIds: [BigInt!]!\n    $typeIn: [String!]!\n    $first: Int!\n    $skip: Int!\n    $orderDirection: OrderDirection!\n  ) {\n    quoteEvents(\n      first: $first\n      skip: $skip\n      orderBy: timestamp\n      orderDirection: $orderDirection\n      where: { quoteId_in: $quoteIds, type_in: $typeIn }\n    ) {\n      id\n      type\n      metadata\n      timestamp\n      blockNumber\n      transaction\n      quoteId\n    }\n  }\n",
): typeof import("./graphql").QuoteEventsForQuotesByTypeDocument;
