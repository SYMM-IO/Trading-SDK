...
import type { DepositAndAllocateForAccountParameters } from "./deposit-and-allocate-for-account";

/**
 * Parameters for {@link simulateDepositAndAllocateForAccount}: the write's
...
/**
 * Dry-run {@link depositAndAllocateForAccount} without sending a transaction.
 * Runs `simulateContract` against the AccountLayer via the public client; a
 * would-be revert throws viem's call error.
 *
