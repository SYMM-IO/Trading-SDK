...
import { buildSubscribeMessage } from "./enigma-notifications";

const ACCOUNT = "0x1111111111111111111111111111111111111111" as Address;

describe("buildSubscribeMessage", () => {
  it("builds a enigma channel_patterns frame scoped to the account", () => {
    const frame = JSON.parse(buildSubscribeMessage({ account: ACCOUNT, channel: "Chan", protocol: "enigma" }));
