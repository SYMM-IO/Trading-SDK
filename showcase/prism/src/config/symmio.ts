 ...
 *
 * Base uses the SDK's production registry plus Prism's affiliate. The low-cap
 * deployment is pinned to the compatible Arbitrum staging stack explicitly:
 * contracts, solver, data services, listing backends and GaslessQ must describe
 * one environment or a successful write can be followed by a read elsewhere.
 */
