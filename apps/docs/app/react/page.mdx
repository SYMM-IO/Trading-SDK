...
- **[SYMMIO Contract](/react/symmio-contract)** — quote reads, pending funding, party positions, collateral, allocate / deallocate, on-chain markets.
...
- **[Markets](/react/markets)** — solver + on-chain market catalog hooks, and a market's on-chain funding state (`useFundingFeesOfPartyB`).
...
- **[Pools](/react/pools)** — `useListingMarkets`, `useSupportsListingService`.
- **[Inventory](/react/inventory)** — `useInventoryTvl`, the custodial TVL a pools page headlines.
