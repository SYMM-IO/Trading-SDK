...
The chain must carry an `inventory` block — `SymmioChainConfig.inventory.url`. Today that is **Arbitrum only** (`https://inventory85.enigma.bz`); see [Addresses](/core/addresses).
