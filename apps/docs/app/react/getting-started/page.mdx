...
<Callout type="info">
  **No affiliate yet?** For testing you can use the **zero address** (`0x0000000000000000000000000000000000000000`) —
  trades still open, you just earn **no share of the trading fee**. For production, **registration** lets your affiliate
  **collect a share of trading fees**. Then set the registered address as `affiliatesAddress`. See{" "}
