...
React-query wrappers over `@theoldvarorg/core`'s AccountLayer slice.
...
```tsx
import { useAllocate } from "@theoldvarorg/react";
...
```tsx
import { useDeallocate } from "@theoldvarorg/react";
...
```tsx
import { useEditAccountName } from "@theoldvarorg/react";
