...
Hooks (`useCandles`, `useCandleStream`) and adapters (`toTradingViewDatafeed`) are written against that interface, never against a venue. Swapping the source swaps the data and nothing else.
