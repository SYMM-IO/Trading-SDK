...
```ts
import { getDelegationExpiry } from "@theoldvarorg/core";
...
```ts
import { getIsDelegationActive } from "@theoldvarorg/core";
...
```ts
import { getDelegationExpiryQueryOptions, getIsDelegationActiveQueryOptions } from "@theoldvarorg/core";
...
```ts
import { getDelegationExpiryQueryKey, getIsDelegationActiveQueryKey } from "@theoldvarorg/core";
...
```ts
import { grantDelegation } from "@theoldvarorg/core";
