...
<MethodIndex kind="read">
  ...
  <MethodEntry name="getQuotesEventsByType" href="/core/subgraph/get-quotes-events-by-type">
    The batched form — decoded events for many quotes, merged and time-sorted server-side into one page.
  </MethodEntry>
...
chain.subgraphs.analytics; // https://.../subgraphs/arbitrum-vibe-mainnet-analytics/latest/gn
chain.subgraphs.events; // https://.../subgraphs/arbitrum-vibe-mainnet-events/stage/gn
```
