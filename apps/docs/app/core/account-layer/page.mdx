...
Pair with [`getAccountBalanceOf`](#getaccountbalanceof) for the full picture: `balanceOf` is the free-to-move pot; `balanceInfoOfPartyA` is the allocated-and-in-play pot.
