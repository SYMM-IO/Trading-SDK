...
- `affiliatesAddress` — `0xBcB033C9154401fA000a1Ae60843f79f45741b7c` (built-in default; you must override it per chain via the required `symmioConfig[chainId].addresses.affiliatesAddress`)
