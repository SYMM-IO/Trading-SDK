...
`@theoldvarorg/react` is the umbrella package — it pulls in `@theoldvarorg/core`, `@theoldvarorg/utils`, and `zustand` transitively. The other four are peer dependencies you control.
...
- Skim the library indexes to see what's available: **[Core](/core)**, **[React](/react)**, **[Utils](/utils)**.
