...
`@symm-frontier/react` is the umbrella package — it pulls in `@symm-frontier/core`, `@symm-frontier/utils`, and `zustand` transitively. The other four are peer dependencies you control.
