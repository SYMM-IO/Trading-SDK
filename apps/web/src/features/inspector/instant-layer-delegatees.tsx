  ...
  return [
    {
      ...
      description: "Delegate to the solver or PartyB address for delegated execution.",
    },
    {
      name: "COH wallet",
      address: COH_WALLET_MAINNET_ADDRESS,
      description: "Conditional Order Handler wallet used by TP/SL delegation.",
    },
    {
      name: "Session key",
      address: sessionKeyAddress,
      description: "Delegate to the browser session-key address. Paste it manually if needed.",
    },
  ];
}
