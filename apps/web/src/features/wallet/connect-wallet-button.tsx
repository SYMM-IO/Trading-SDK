...
/**
 * A single "Connect Wallet" button that opens a modal listing every wallet
 * connector registered in the host's wagmi config. Each option shows the
 * wallet's own icon, a connecting spinner, and surfaces connect errors inline —
 * replacing a row of one-button-per-connector controls.
 */
