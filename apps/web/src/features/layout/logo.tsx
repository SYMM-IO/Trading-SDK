 ...
 * bar. The brackets inherit `currentColor` so the mark reads correctly in both
 * light and dark; the center bar keeps the fixed Symmio coral. Size via
 * className (defaults to `h-6 w-auto`, aspect preserved).
 */
