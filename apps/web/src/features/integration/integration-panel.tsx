...
import { useCollateralBalance, useSymmioConfig, useUserSubAccounts, useWalletAccount } from "@theoldvarorg/react";
 ...
 * `@theoldvarorg/react` hooks. Each flow walks Connect → Select subaccount →
  ...
  return (
    <section className="mx-auto flex w-full max-w-3xl flex-col gap-8 px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
      <PageHeader
        ...
        description="A production-grade deposit, withdraw, and instant-open wizard composed entirely from @theoldvarorg/react hooks — the same surface a third-party integrator would build on."
      />
